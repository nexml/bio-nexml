...
a NeXML instance document can contain sets of Operational Taxonomic Units
(OTUs, the tips in phylogenetic trees, and that which comparative observations
are made on. Often these are species, i.e. "taxa"), sets of phylogenetic trees
(or reticular trees, i.e. networks), and sets of comparative data (molecular
sequences, morphological categorical data, continuous data, and other types).
